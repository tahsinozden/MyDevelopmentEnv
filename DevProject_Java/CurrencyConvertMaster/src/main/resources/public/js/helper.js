...
app.controller('TypeaheadCtrl', function($scope, $http) {
  ...
  // $scope.getCurrencies = function(val) {
    // return $http.get('http://localhost:8080/currency_service/currencies', {
      // params: {
        // address: val,
        // sensor: false
      // }
...
////  var allCurs = $scope.getCurrencies();
////  $scope.getCurrencies();
//  for (var item in $scope.allCurs){
//  	$scope.allCurrencyCodes.append(allCurs[item].code);
//  }
//  console.log("All currencies : ");
//  console.log($scope.allCurs);
//  console.log($scope.allCurrencyCodes);
  // $scope.allCurrencyCodes = ['USD', 'TRY', 'PLN'];
